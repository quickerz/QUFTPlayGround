/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘QuickAPITest1.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity10Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>48bacc1c-7cf2-4147-bc4f-859b394da599</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>CityPairs!Output</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>False</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>CityPairs</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{CityPairs!Output.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>Output$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            string xmlDataFetchActivity7Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>fc7d5fec-b4f1-4d39-94dc-af2976ac1cf2</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>CityPairs!Input</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>False</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value>CityPairs</Value></QueryParameter><QueryParameter><Name>FilePath</Name><Value>" + _context.ResourceManager.GetValue("{CityPairs!Input.TablePath}") + "</Value></QueryParameter><QueryParameter><Name>SheetName</Name><Value>Input$</Value></QueryParameter><QueryParameter><Name>ContainsHeadersRow</Name><Value>True</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            binding_setter22 = new StringFormaterDecorator(binding_setter22,"{Step.DataFetchActivity10.OutTable}");
            bind_dir22 = new BindDirection(_flow.DataFetchActivity10,binding_getter22,binding_setter22,BindTargetType.ToInProperty);
            _flow.DataExporterActivity12.InDirections.Add(bind_dir22);
            ...
            binding_setter25 = new StringFormaterDecorator(binding_setter25,"{Step.DataFetchActivity7.OutTable}");
            bind_dir25 = new BindDirection(_flow.DataFetchActivity7,binding_getter25,binding_setter25,BindTargetType.ToInProperty);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.CityPairs!Input.DepartureCity}</DepartureCity><ArrivalCity>{DataSource.CityPairs!Input.ArrivalCity}</ArrivalCity><FlightDate>2022-12-25T00:00:00+08:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi51 = new VTDPropertyInfoBase("DepartureCity");
            VTDBaseGetter binding_getter26 = new VTDObjectGetter(pi51);
            VTDPropertyInfoBase pi52 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter26 = new VTDXPathSetter(pi52,XmlTypeCode.String);
            binding_setter26 = new StringFormaterDecorator(binding_setter26,"{DataSource.CityPairs!Input.DepartureCity}");
            ...
            VTDPropertyInfoBase pi53 = new VTDPropertyInfoBase("ArrivalCity");
            VTDBaseGetter binding_getter27 = new VTDObjectGetter(pi53);
            VTDPropertyInfoBase pi54 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter27 = new VTDXPathSetter(pi54,XmlTypeCode.String);
            binding_setter27 = new StringFormaterDecorator(binding_setter27,"{DataSource.CityPairs!Input.ArrivalCity}");
            bind_dir27 = new BindDirection(this.DataCursorActivity14,binding_getter27,binding_setter27,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir27);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>Quick1</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>3</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi55 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][{Array0}]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseGetter binding_getter28 = new VTDXPathGetter(pi55,XmlTypeCode.Int);
            ...
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir28);
            VTDPropertyInfoBase pi57 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter29 = new VTDXPathGetter(pi57,XmlTypeCode.DateTime);
            ...
            bind_dir29 = new BindDirection(_flow.StServiceCallActivity4,binding_getter29,binding_setter29,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir29);
