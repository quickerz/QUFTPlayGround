...
TotalPrice = quantity * ConvertedValue
TotalPrice = FormatCurrency(TotalPrice)
ExpectedResult = trim(DataTable("ExpectedResult", dtGlobalSheet))

If TotalPrice = ExpectedResult Then
	Reporter.ReportEvent micPass, "Price Check", "Calculation Passed"
	DataTable("Status", dtGlobalSheet) = "Passed"
else
	Reporter.ReportEvent micFail, "Price Check", "Calculation Failed"
	DataTable("Status", dtGlobalSheet) = "Failed"
End If
